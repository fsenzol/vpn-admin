...
echo ""
echo "======================="
echo "  Done Install Web admin  "
echo "======================="
echo "http://$IP:10000"
echo "======================="
echo "Script By  @fsenzol"
}
function restart () {
echo " Restarting Web admin"
sleep 0.5
service webmin restart > /dev/null 2>&1
echo " Start Uninstall Web admin"
clear
echo ""
echo "======================="
echo "  Done Restart Web admin  "
echo "======================="
...
echo ""
echo "========================="
echo "  Done Uninstalling Web admmin  "
echo "========================="
echo "Script By  @fsenzol"
}
if [[ "$cek" = "perl" ]]; then
...
echo -e "================================"
echo -e "1.Install Web admin"
echo -e "2.Restart Web admin"
echo -e "3.Uninstall Web admin"
echo -e "================================"
